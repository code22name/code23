...
from ADSB_VK import ADSB_VK  # grc-generated hier_block
...
class VK3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "VK3")
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.gsm_message_file_sink_0 = grgsm.message_file_sink('/home/vib-dragon/Documents/outmsg.msg')
        self.blocks_null_sink_0_0 = blocks.null_sink(gr.sizeof_float*1)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 0.0010)
        self.ADSB_VK_0 = ADSB_VK(
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ADSB_VK_0, 'ADSB Demodulated Output'), (self.gsm_message_file_sink_0, 'in'))
        self.msg_connect((self.ADSB_VK_0, 'Decoded Data'), (self.zeromq_pub_msg_sink_0, 'in'))
        self.connect((self.ADSB_VK_0, 1), (self.blocks_null_sink_0_0, 0))
        self.connect((self.ADSB_VK_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.analog_const_source_x_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.blocks_complex_to_real_0, 0), (self.ADSB_VK_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ADSB_VK_0.set_samp_rate(self.samp_rate)
...
def main(top_block_cls=VK3, options=None):
