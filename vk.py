...
class vk(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "vk1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("vk1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "vk")
        ...
        # Blocks
        ##################################################
        self.zeromq_pub_msg_sink_0_0 = zeromq.pub_msg_sink('tcp://127.0.0.1:5002', 100)
        ...
        self.rtlsdr_source_0.set_center_freq(1.09e9, 0)
        ...
        self.connect((self.adsb_demod_0, 0), (self.qtgui_time_sink_x_0_0, 0))
...
def main(top_block_cls=vk, options=None):
